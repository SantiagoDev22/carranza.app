  ...
  return (
    <>
      <button className="relative" onClick={() => setOpenModal(true)}>
        ...
        <figure className="w-[18px] h-[18px] bg-oc-brown-1 rounded-full flex justify-center items-center absolute -right-[0.3rem] top-3">
          <span className="text-center text-white flex justify-center text-xs items-center">
            {total}
          </span>
        </figure>
      </button>
