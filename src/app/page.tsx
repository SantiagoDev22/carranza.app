          ...
          <div className="flex flex-col gap-y-20">
            <div className="flex flex-col-reverse gap-y-10 xl:grid grid-cols-2 items-center gap-x-24 2xl:gap-x-36">
                ...
                <div className="flex flex-col gap-y-5">
                  ...
                  <div className="flex justify-center xl:justify-start">
                    <a href="/lo-mas-vendido/shampoo-anticaída" className="text-black text-lg hover:text-white hover:bg-oc-brown-1 transition bg-white border border-oc-brown-1 py-2 px-4">
                      Comprar
                    </a>
                  </div>
                </div>
            ...
            <div className="gap-y-10 grid xl:grid-cols-2 items-center gap-x-24 2xl:gap-x-36">
                <div className="flex flex-col gap-y-5">
                  ...
                  <div className="flex justify-center xl:justify-start">
                    <a href="/lo-mas-vendido/tonico-capilar" className="text-black text-lg hover:text-white hover:bg-oc-brown-1 transition bg-white border border-oc-brown-1 py-2 px-4">
                      Comprar
                    </a>
                  </div>
                </div>
            ...
            <div className="flex flex-col-reverse gap-y-10 xl:grid grid-cols-2 items-center gap-x-24 2xl:gap-x-36">
                ...
                <div className="flex flex-col gap-y-5">
                  ...
                  <div className="flex justify-center xl:justify-start">
                    <a href="/lo-mas-vendido/suplemento-saw-palmetto" className="text-black text-lg hover:text-white hover:bg-oc-brown-1 transition bg-white border border-oc-brown-1 py-2 px-4">
                      Comprar
                    </a>
                  </div>
                </div>
