      ...
      {products.map((product) => {
        ...
        return (
          ...
          >
            ...
            <div className="flex gap-x-2 pt-2 justify-between">
              ...
              <button
                ...
                className="text-black w-full text-base rounded-3xl hover:text-white hover:bg-oc-brown-1 transition bg-white border border-oc-brown-1 py-2 px-4 min-w-24">
